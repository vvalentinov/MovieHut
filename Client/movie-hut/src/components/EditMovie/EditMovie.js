    ...
    const onSubmit = (e) => {
        ...
        if (imageData.imageFile) {
            imageService
                ...
                .then(imgRes => {
                    movieService
                        .edit({ ...inputData, id: movieId, posterUrl: imgRes.imageUrl })
                        .then((res) => {
                            //Update context
                            //update(res);
                            //Stop spinner
                                    ...
                                    <div className='col-4'>
                                        <div className='text-center text-lg-start mt-2 pt-2'>
                                            <button
                                                ...
                                                disabled={!isValidForm || (!inputData.title || !inputData.plot || !inputData.released || !inputData.trailerUrl || !inputData.duration || !visualizationImageUrl || addedActors.length <= 0 || addedDirectors.length <= 0 || !areChecked.some(x => x === true))}
                                                style={{
                                                    paddingLeft: '2.5rem',
                                                    paddingRight: '2.5rem',
